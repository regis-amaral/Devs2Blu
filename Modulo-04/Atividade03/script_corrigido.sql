...
-- MUDAR TIPO CAMPO TELEFONE PARA CHAR(11)
...
-- MESA
-- MUDAR OBRIGATORIEDADE DO CAMPO ATENDENTEID
-- MUDAR OBRIGATORIEDADE DO CAMPO STATUSMESAID
...
-- USUARIO
-- ALTERAR LOGIN PARA VARCHAR(100)
